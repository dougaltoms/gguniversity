...
A corresponding colour palette can be generated for your `ggplot2` visualisations, using the `<university>_palette()` function:

```{r}
library(gguniversity)
library(scales)

exe_pal <- gguniversity::exeter_palette(6)

scales::show_col(exe_pal, ncol = 6, border=NA, labels=F)
```
